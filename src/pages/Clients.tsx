  ...
  const [clients, setClients] = useState<Client[]>([
    {
      ...
      gender: '',
      nationality: '',
      countryOfRegistration: 'Tanzania',
      ...
      phoneNumber: '+255 234 567 8901',
      emailAddress: 'info@abccorp.co.tz',
      activePolicies: 3,
    ...
    },
    {
      ...
      clientType: 'corporate',
      title: 'Dr',
      fullName: 'DEF Industries Limited',
      dateOfBirth: '',
      idType: '',
      idNumber: '',
      gender: '',
      ...
      phoneNumber: '+255 234 567 8903',
      emailAddress: 'contact@defindustries.co.tz',
      activePolicies: 5,
